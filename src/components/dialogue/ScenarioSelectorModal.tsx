...
import { X, Play, MapPin, Tag } from 'lucide-react';
...
export default function ScenarioSelectorModal({ onClose, onSelect }: ScenarioSelectorModalProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {ALL_SCENARIOS.map(scenario => (
              <div 
                ...
                className="bg-white rounded-2xl border border-slate-200 p-5 hover:border-blue-300 hover:shadow-md transition-all cursor-pointer group flex flex-col h-full relative overflow-hidden"
              >
                ...
                <div className="mt-auto pt-4 border-t border-slate-100 flex justify-between items-center relative z-10">
                  ...
                  <div className="w-8 h-8 rounded-full bg-slate-100 group-hover:bg-blue-600 group-hover:text-white text-slate-400 flex items-center justify-center transition-colors">
