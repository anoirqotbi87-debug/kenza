const fs = require('fs');
let content = fs.readFileSync('src/data/module4.ts', 'utf8');
...
if (startIdx !== -1) {
    const finalContent = content.substring(0, startIdx) + newModaux;
    fs.writeFileSync('src/data/module4.ts', finalContent, 'utf8');
    console.log('Success!');
} else {
